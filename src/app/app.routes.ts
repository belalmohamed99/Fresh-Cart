...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "products", loadComponent: () => import("./featur/pages/products/products.component").then(c => c.ProductsComponent), title: "Products" },
      ...
      {
        path: "setting",
        loadComponent: () => import("./featur/pages/profile-setting/profile-setting.component").then(c => c.ProfileSettingComponent),
        title: "Setting",
        children: [
      ...
      { path: "product-detalis/:id", loadComponent: () => import("./featur/pages/product-detalis/product-detalis.component").then(c => c.ProductDetalisComponent), title: "Product Details" },
